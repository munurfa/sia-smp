            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <?php $no=$this->uri->segment(3)+1; 
                    ...
                    <tr>
                        ...
                        <td>
                        	<a href="<?php echo base_url('siswa/ubah/').$u->id_user; ?>" class="btn btn-warning btn-xs">Edit</a>
                            <a onclick="return confirm('Apakah Yakin Data Ini Akan Dihapus ?')" href="<?php echo base_url('siswa/hapus/').$u->id_user; ?>" class="btn btn-danger btn-xs">Hapus</a>
                        </td>
                    </tr>
                <?php $no++; } ?>
                </tbody>
