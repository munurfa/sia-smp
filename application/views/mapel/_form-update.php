    ...
    <fieldset>
        <table width="100%">
	    	<tr>
	    		...
	    		<td width="80%"><?php echo form_input('kd_mapel',$mapel->kd_mapel,array('class' => 'form-control' )); ?></td>
	    	</tr>
	    	<tr>
	    		<td width="20%"><label for="nama_mapel">Nama Mapel</label></td>
	    		<td width="80%"><?php echo form_input('nama_mapel',$mapel->nama_mapel,array('class' => 'form-control' )); ?></td>
	    	</tr>
	    	...
	    	<tr>
	    		...
	    		<?php 
					...
					echo form_dropdown('kelas', $options, $mapel->kelas,array('class' => 'form-control' ));
	    		 ?>
	    	...
	    	<tr>
	    		...
	    		<td width="80%"><?php echo form_input('kkm',$mapel->kkm,array('class' => 'form-control' )); ?></td>
	    	</tr>
    	</table>                 
